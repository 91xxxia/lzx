<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['ClinicalSys:contacts:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['ClinicalSys:contacts:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['ClinicalSys:contacts:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['ClinicalSys:contacts:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="contactsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="联系人号" align="center" prop="contactId" />
      <el-table-column label="病人号" align="center" prop="patientId" />
      <el-table-column label="联系方式" align="center" prop="phone" />
      <el-table-column label="紧急联系方式" align="center" prop="emergencyContact" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="紧急联系方式" prop="emergencyContact">
          <el-input v-model="form.emergencyContact" placeholder="请输入紧急联系方式" />
        </el-form-item>
...
<script>
import { listContacts, getContacts, delContacts, addContacts, updateContacts } from "@/api/ClinicalSys/contacts"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('ClinicalSys/contacts/export', {
        ...this.queryParams
