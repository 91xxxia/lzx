...
public class SpecimenStorageController extends BaseController
{
    ...
    @Log(title = "样本存储", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    public void export(HttpServletResponse response, SpecimenStorage specimenStorage)
    {
        ...
        util.exportExcel(response, list, "样本存储数据");
    }
    ...
    @Log(title = "样本存储", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "样本存储", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "样本存储", businessType = BusinessType.DELETE)
