 ...
 */
@RestController
@RequestMapping("/BiobankSys/micdata")
public class MicrobiomeDataController extends BaseController
{
     ...
     * 查询微生物组数据列表
     */
    @PreAuthorize("@ss.hasPermi('BiobankSys:micdata:list')")
    @GetMapping("/list")
     ...
     * 导出微生物组数据列表
     */
    @PreAuthorize("@ss.hasPermi('BiobankSys:micdata:export')")
     ...
     * 获取微生物组数据详细信息
     */
    @PreAuthorize("@ss.hasPermi('BiobankSys:micdata:query')")
     ...
     * 新增微生物组数据
     */
    @PreAuthorize("@ss.hasPermi('BiobankSys:micdata:add')")
     ...
     * 修改微生物组数据
     */
    @PreAuthorize("@ss.hasPermi('BiobankSys:micdata:edit')")
     ...
     * 删除微生物组数据
     */
    @PreAuthorize("@ss.hasPermi('BiobankSys:micdata:remove')")
