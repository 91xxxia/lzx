<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="linkList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="临床诊断号" align="center" prop="clinicalDiagnosisId" />
      <el-table-column label="临床症状号" align="center" prop="clinicalSymptomId" />
      <el-table-column label="临床用药号" align="center" prop="clinicalMedicationId" />
      <el-table-column label="临床实验室检查号" align="center" prop="clinicalTestId" />
      <el-table-column label="关联类型" align="center" prop="linkType" />
      <el-table-column label="临床注意事项" align="center" prop="clinicalNotes" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="临床诊断号" prop="clinicalDiagnosisId">
          <el-input v-model="form.clinicalDiagnosisId" placeholder="请输入临床诊断号" />
        </el-form-item>
        <el-form-item label="临床症状号" prop="clinicalSymptomId">
          <el-input v-model="form.clinicalSymptomId" placeholder="请输入临床症状号" />
        </el-form-item>
        <el-form-item label="临床用药号" prop="clinicalMedicationId">
          <el-input v-model="form.clinicalMedicationId" placeholder="请输入临床用药号" />
        </el-form-item>
        <el-form-item label="临床实验室检查号" prop="clinicalTestId">
          <el-input v-model="form.clinicalTestId" placeholder="请输入临床实验室检查号" />
        </el-form-item>
        <el-form-item label="关联类型" prop="linkType">
          <el-input v-model="form.linkType" placeholder="请输入关联类型" />
        </el-form-item>
        <el-form-item label="临床注意事项" prop="clinicalNotes">
          <el-input v-model="form.clinicalNotes" type="textarea" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除样本临床关联编号为"' + linkIds + '"的数据项？').then(function() {
