<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="eventsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="临床就诊号" align="center" prop="clinicalVisitId" />
      ...
      <el-table-column label="收集者编号" align="center" prop="collectorId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="临床就诊号" prop="clinicalVisitId">
          <el-input v-model="form.clinicalVisitId" placeholder="请输入临床就诊号" />
        </el-form-item>
        ...
        <el-form-item label="收集者编号" prop="collectorId">
          <el-input v-model="form.collectorId" placeholder="请输入收集者编号" />
        </el-form-item>
      </el-form>
