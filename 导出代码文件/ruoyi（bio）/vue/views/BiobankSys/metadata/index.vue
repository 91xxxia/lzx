<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="metadataList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="其他代谢数据" align="center" prop="otherMetabolites" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="其他代谢数据" prop="otherMetabolites">
          <el-input v-model="form.otherMetabolites" type="textarea" placeholder="请输入内容" />
        </el-form-item>
