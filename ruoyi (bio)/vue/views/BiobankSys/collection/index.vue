  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="表格填写人" prop="formCompletedBy">
        <el-input
          v-model="queryParams.formCompletedBy"
          placeholder="请输入表格填写人"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="表格填写日期" prop="formCompletionDate">
        <el-date-picker clearable
          v-model="queryParams.formCompletionDate"
          type="date"
      ...
      <el-form-item label="是否空腹" prop="patientFasting">
        <el-input
          v-model="queryParams.patientFasting"
          placeholder="请输入是否空腹"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="最后进食时间" prop="lastMealTime">
        <el-date-picker clearable
          v-model="queryParams.lastMealTime"
          type="date"
          value-format="yyyy-MM-dd"
      ...
      <el-form-item label="处理延迟时间(分钟)" prop="processingDelayMinutes">
        <el-input
          v-model="queryParams.processingDelayMinutes"
          placeholder="请输入处理延迟时间(分钟)"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="分装体积" prop="aliquotVolume">
        <el-input
          v-model="queryParams.aliquotVolume"
          placeholder="请输入分装体积"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="采集者签名" prop="collectorSignature">
        <el-input
          v-model="queryParams.collectorSignature"
          placeholder="请输入采集者签名"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="collectionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="病例报告号" align="center" prop="crfId" />
      ...
      <el-table-column label="处理延迟时间(分钟)" align="center" prop="processingDelayMinutes" />
      <el-table-column label="分装体积" align="center" prop="aliquotVolume" />
      <el-table-column label="添加剂类型" align="center" prop="additiveType" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="处理延迟时间(分钟)" prop="processingDelayMinutes">
          <el-input v-model="form.processingDelayMinutes" placeholder="请输入处理延迟时间(分钟)" />
        </el-form-item>
        <el-form-item label="分装体积" prop="aliquotVolume">
          <el-input v-model="form.aliquotVolume" placeholder="请输入分装体积" />
        </el-form-item>
        <el-form-item label="采集者签名" prop="collectorSignature">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除样本采集CRF编号为"' + crfIds + '"的数据项？').then(function() {
