<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="IL-4水平" prop="il4Level">
        <el-input
          v-model="queryParams.il4Level"
          placeholder="请输入IL-4水平"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="IL-5水平" prop="il5Level">
        <el-input
          v-model="queryParams.il5Level"
          placeholder="请输入IL-5水平"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="IL-13水平" prop="il13Level">
        <el-input
          v-model="queryParams.il13Level"
          placeholder="请输入IL-13水平"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="IgE水平" prop="igeLevel">
        <el-input
          v-model="queryParams.igeLevel"
          placeholder="请输入IgE水平"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="prodataList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="蛋白质组号" align="center" prop="proteomicId" />
      ...
      <el-table-column label="IL-4水平" align="center" prop="il4Level" />
      <el-table-column label="IL-5水平" align="center" prop="il5Level" />
      <el-table-column label="IL-13水平" align="center" prop="il13Level" />
      <el-table-column label="IgE水平" align="center" prop="igeLevel" />
      <el-table-column label="细胞因子谱数据" align="center" prop="cytokineProfile" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="IL-4水平" prop="il4Level">
          <el-input v-model="form.il4Level" placeholder="请输入IL-4水平" />
        </el-form-item>
        <el-form-item label="IL-5水平" prop="il5Level">
          <el-input v-model="form.il5Level" placeholder="请输入IL-5水平" />
        </el-form-item>
        <el-form-item label="IL-13水平" prop="il13Level">
          <el-input v-model="form.il13Level" placeholder="请输入IL-13水平" />
        </el-form-item>
        <el-form-item label="IgE水平" prop="igeLevel">
          <el-input v-model="form.igeLevel" placeholder="请输入IgE水平" />
        </el-form-item>
        <el-form-item label="细胞因子谱数据" prop="cytokineProfile">
          <file-upload v-model="form.cytokineProfile"/>
        </el-form-item>
        <el-form-item label="日期文件路径" prop="dataFilePath">
