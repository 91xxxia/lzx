...
public class SpecimenClinicalLinkController extends BaseController
{
    ...
    @Log(title = "样本-临床关联", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    public void export(HttpServletResponse response, SpecimenClinicalLink specimenClinicalLink)
    {
        ...
        util.exportExcel(response, list, "样本-临床关联数据");
    }
    ...
    @Log(title = "样本-临床关联", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "样本-临床关联", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "样本-临床关联", businessType = BusinessType.DELETE)
