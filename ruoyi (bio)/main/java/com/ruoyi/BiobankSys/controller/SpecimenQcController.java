...
public class SpecimenQcController extends BaseController
{
    ...
    @Log(title = "样本质量控表", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    public void export(HttpServletResponse response, SpecimenQc specimenQc)
    {
        ...
        util.exportExcel(response, list, "样本质量控表数据");
    }
    ...
    @Log(title = "样本质量控表", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "样本质量控表", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "样本质量控表", businessType = BusinessType.DELETE)
	@DeleteMapping("/{qcIds}")
