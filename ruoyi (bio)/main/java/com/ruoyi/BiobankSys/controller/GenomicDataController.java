 ...
 */
@RestController
@RequestMapping("/BiobankSys/data")
public class GenomicDataController extends BaseController
{
     ...
     * 查询基因组数据列表
     */
    @PreAuthorize("@ss.hasPermi('BiobankSys:data:list')")
    @GetMapping("/list")
     ...
     * 导出基因组数据列表
     */
    @PreAuthorize("@ss.hasPermi('BiobankSys:data:export')")
     ...
     * 获取基因组数据详细信息
     */
    @PreAuthorize("@ss.hasPermi('BiobankSys:data:query')")
     ...
     * 新增基因组数据
     */
    @PreAuthorize("@ss.hasPermi('BiobankSys:data:add')")
     ...
     * 修改基因组数据
     */
    @PreAuthorize("@ss.hasPermi('BiobankSys:data:edit')")
     ...
     * 删除基因组数据
     */
    @PreAuthorize("@ss.hasPermi('BiobankSys:data:remove')")
