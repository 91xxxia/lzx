...
public class BiospecimensController extends BaseController
{
    ...
    @Log(title = "生物样本主表", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    public void export(HttpServletResponse response, Biospecimens biospecimens)
    {
        ...
        util.exportExcel(response, list, "生物样本主表数据");
    }
    ...
    @Log(title = "生物样本主表", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "生物样本主表", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "生物样本主表", businessType = BusinessType.DELETE)
