...
CREATE TABLE `clinical_other_treatments`  (
  ...
  CONSTRAINT `clinical_other_treatments_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `contacts`  (
  ...
  INDEX `patient_id`(`patient_id` ASC) USING BTREE,
  CONSTRAINT `contacts_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of contacts
-- ----------------------------
INSERT INTO `contacts` VALUES (2, '002', '112342', '23145234', '无');
...
CREATE TABLE `diagnoses`  (
  ...
  INDEX `patient_id`(`patient_id` ASC) USING BTREE,
  CONSTRAINT `diagnoses_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `expenses`  (
  ...
  INDEX `patient_id`(`patient_id` ASC) USING BTREE,
  CONSTRAINT `expenses_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `family_history`  (
  ...
  INDEX `patient_id`(`patient_id` ASC) USING BTREE,
  CONSTRAINT `family_history_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `feno_tests`  (
  ...
  INDEX `patient_id`(`patient_id` ASC) USING BTREE,
  CONSTRAINT `feno_tests_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `followup_notes`  (
  ...
  INDEX `patient_id`(`patient_id` ASC) USING BTREE,
  CONSTRAINT `followup_notes_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `gen_table` VALUES (14, 'expenses', '费用', NULL, NULL, 'Expenses', 'crud', 'element-ui', 'com.ruoyi.ClinicalSys', 'ClinicalSys', 'expenses', '费用', 'ruoyi', '0', '/', '{\"parentMenuId\":2061}', 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:35:24', NULL);
INSERT INTO `gen_table` VALUES (15, 'family_history', '家族史', NULL, NULL, 'FamilyHistory', 'crud', 'element-ui', 'com.ruoyi.ClinicalSys', 'ClinicalSys', 'family_history', '家族史', 'ruoyi', '0', '/', '{\"parentMenuId\":2061}', 'admin', '2025-06-27 14:25:10', '', '2025-06-27 16:09:47', NULL);
INSERT INTO `gen_table` VALUES (16, 'feno_tests', '呼出气一氧化氮检测', NULL, NULL, 'FenoTests', 'crud', 'element-ui', 'com.ruoyi.ClinicalSys', 'ClinicalSys', 'tests', '呼出气一氧化氮检测', 'ruoyi', '0', '/', '{\"parentMenuId\":2061}', 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:39:49', NULL);
INSERT INTO `gen_table` VALUES (17, 'followup_notes', '随访信息', NULL, NULL, 'FollowupNotes', 'crud', 'element-ui', 'com.ruoyi.ClinicalSys', 'ClinicalSys', 'notes', '随访信息', 'ruoyi', '0', '/', '{\"parentMenuId\":2061}', 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:41:43', NULL);
INSERT INTO `gen_table` VALUES (18, 'history', '既往史', NULL, NULL, 'History', 'crud', 'element-ui', 'com.ruoyi.ClinicalSys', 'ClinicalSys', 'history', '既往史', 'ruoyi', '0', '/', '{\"parentMenuId\":2061}', 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:32:56', NULL);
INSERT INTO `gen_table` VALUES (19, 'imaging', '影像学检查', NULL, NULL, 'Imaging', 'crud', 'element-ui', 'com.ruoyi.ClinicalSys', 'ClinicalSys', 'imaging', '影像学检查', 'ruoyi', '0', '/', '{\"parentMenuId\":2061}', 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:45:46', NULL);
...
INSERT INTO `gen_table` VALUES (21, 'lab_tests', '实验室检查', NULL, NULL, 'LabTests', 'crud', 'element-ui', 'com.ruoyi.ClinicalSys', 'ClinicalSys', 'lab_tests', '实验室检查', 'ruoyi', '0', '/', '{\"parentMenuId\":2061}', 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:52:11', NULL);
INSERT INTO `gen_table` VALUES (22, 'lung_tests', '肺功能检查', NULL, NULL, 'LungTests', 'crud', 'element-ui', 'com.ruoyi.ClinicalSys', 'ClinicalSys', 'lung_tests', '肺功能检查', 'ruoyi', '0', '/', '{\"parentMenuId\":2061}', 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:52:22', NULL);
...
INSERT INTO `gen_table` VALUES (25, 'medications_history', '既往用药史', NULL, NULL, 'MedicationsHistory', 'crud', 'element-ui', 'com.ruoyi.ClinicalSys', 'ClinicalSys', 'medications_history', '既往用药史', 'ruoyi', '0', '/', '{\"parentMenuId\":2061}', 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:52:57', NULL);
...
INSERT INTO `gen_table_column` VALUES (145, 14, 'expense_id', '费用号', 'int', 'Long', 'expenseId', '1', '1', '0', '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:35:24');
INSERT INTO `gen_table_column` VALUES (146, 14, 'patient_id', '病人号', 'varchar(20)', 'String', 'patientId', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:35:24');
INSERT INTO `gen_table_column` VALUES (147, 14, 'expense_type', '费用类别', 'varchar(100)', 'String', 'expenseType', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'select', '', 3, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:35:24');
INSERT INTO `gen_table_column` VALUES (148, 14, 'amount', '费用', 'decimal(10,2)', 'BigDecimal', 'amount', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'input', '', 4, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:35:24');
INSERT INTO `gen_table_column` VALUES (149, 15, 'fam_id', '家族号', 'int', 'Long', 'famId', '1', '1', '0', '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 16:09:47');
INSERT INTO `gen_table_column` VALUES (150, 15, 'patient_id', '病人号', 'varchar(20)', 'String', 'patientId', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 16:09:47');
INSERT INTO `gen_table_column` VALUES (151, 15, 'relative_relation', '相对关系', 'varchar(50)', 'String', 'relativeRelation', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'input', '', 3, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 16:09:47');
INSERT INTO `gen_table_column` VALUES (152, 15, 'allergy_disease', '过敏性疾病', 'text', 'String', 'allergyDisease', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'textarea', '', 4, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 16:09:47');
INSERT INTO `gen_table_column` VALUES (153, 16, 'feno_id', '检测号', 'int', 'Long', 'fenoId', '1', '1', '0', '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:39:49');
INSERT INTO `gen_table_column` VALUES (154, 16, 'patient_id', '病人号', 'varchar(20)', 'String', 'patientId', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:39:49');
INSERT INTO `gen_table_column` VALUES (155, 16, 'test_name', '检查名称', 'varchar(100)', 'String', 'testName', '0', '0', '0', '1', '1', '1', '0', 'LIKE', 'input', '', 3, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:39:49');
INSERT INTO `gen_table_column` VALUES (156, 16, 'test_date', '检查日期', 'date', 'Date', 'testDate', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'datetime', '', 4, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:39:49');
INSERT INTO `gen_table_column` VALUES (157, 16, 'test_result', '检测值', 'text', 'String', 'testResult', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'textarea', '', 5, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:39:49');
INSERT INTO `gen_table_column` VALUES (158, 17, 'followup_id', '随访号', 'int', 'Long', 'followupId', '1', '1', '0', '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:41:43');
INSERT INTO `gen_table_column` VALUES (159, 17, 'patient_id', '病人号', 'varchar(20)', 'String', 'patientId', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:41:43');
INSERT INTO `gen_table_column` VALUES (160, 17, 'symptom_improvement', '过敏症状改善情况', 'text', 'String', 'symptomImprovement', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'textarea', '', 3, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:41:43');
INSERT INTO `gen_table_column` VALUES (161, 17, 'physical_development', '身体发育情况', 'text', 'String', 'physicalDevelopment', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'textarea', '', 4, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:41:43');
INSERT INTO `gen_table_column` VALUES (162, 17, 'adverse_reactions', '药物不良反应', 'text', 'String', 'adverseReactions', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'textarea', '', 5, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:41:43');
INSERT INTO `gen_table_column` VALUES (163, 17, 'reaction_management', '不良反应处理方法', 'text', 'String', 'reactionManagement', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'textarea', '', 6, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:41:43');
INSERT INTO `gen_table_column` VALUES (164, 18, 'history_id', '既往史名', 'int', 'Long', 'historyId', '1', '1', '0', '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:32:56');
INSERT INTO `gen_table_column` VALUES (165, 18, 'patient_id', '病人号', 'varchar(20)', 'String', 'patientId', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:32:56');
INSERT INTO `gen_table_column` VALUES (166, 18, 'food_allergy_history', '食物过敏源阳性史', 'text', 'String', 'foodAllergyHistory', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'textarea', '', 3, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:32:56');
INSERT INTO `gen_table_column` VALUES (167, 18, 'allergen_exposure', '吸入过敏源阳性史', 'text', 'String', 'allergenExposure', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'textarea', '', 4, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:32:56');
INSERT INTO `gen_table_column` VALUES (168, 18, 'past_disease_history', '过敏性疾病史', 'text', 'String', 'pastDiseaseHistory', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'textarea', '', 5, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:32:56');
INSERT INTO `gen_table_column` VALUES (169, 19, 'imaging_id', '影像学号', 'int', 'Long', 'imagingId', '1', '1', '0', '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:45:46');
INSERT INTO `gen_table_column` VALUES (170, 19, 'patient_id', '病人号', 'varchar(20)', 'String', 'patientId', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:45:46');
INSERT INTO `gen_table_column` VALUES (171, 19, 'imaging_type', '影像学检查名称', 'varchar(100)', 'String', 'imagingType', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'input', '', 3, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:45:46');
INSERT INTO `gen_table_column` VALUES (172, 19, 'imaging_date', '检查时期', 'date', 'Date', 'imagingDate', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'datetime', '', 4, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:45:46');
INSERT INTO `gen_table_column` VALUES (173, 19, 'report', '检查报告', 'text', 'String', 'report', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'textarea', '', 5, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 14:45:46');
...
INSERT INTO `gen_table_column` VALUES (178, 21, 'test_id', '实验室检查号', 'int', 'Long', 'testId', '1', '1', '0', '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:52:11');
INSERT INTO `gen_table_column` VALUES (179, 21, 'patient_id', '病人号', 'varchar(20)', 'String', 'patientId', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:52:11');
INSERT INTO `gen_table_column` VALUES (180, 21, 'test_name', '检查项目名称', 'varchar(100)', 'String', 'testName', '0', '0', '0', '1', '1', '1', '0', 'LIKE', 'input', '', 3, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:52:11');
INSERT INTO `gen_table_column` VALUES (181, 21, 'test_date', '检查日期', 'date', 'Date', 'testDate', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'datetime', '', 4, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:52:11');
INSERT INTO `gen_table_column` VALUES (182, 21, 'test_result', '检查值', 'text', 'String', 'testResult', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'textarea', '', 5, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:52:11');
INSERT INTO `gen_table_column` VALUES (183, 22, 'lung_id', '肺功能检查号', 'int', 'Long', 'lungId', '1', '1', '0', '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:52:22');
INSERT INTO `gen_table_column` VALUES (184, 22, 'patient_id', '病人号', 'varchar(20)', 'String', 'patientId', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:52:22');
INSERT INTO `gen_table_column` VALUES (185, 22, 'test_name', '检查名称', 'varchar(100)', 'String', 'testName', '0', '0', '0', '1', '1', '1', '0', 'LIKE', 'input', '', 3, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:52:22');
INSERT INTO `gen_table_column` VALUES (186, 22, 'test_date', '检查日期', 'date', 'Date', 'testDate', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'datetime', '', 4, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:52:22');
INSERT INTO `gen_table_column` VALUES (187, 22, 'test_result', '检查值', 'text', 'String', 'testResult', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'textarea', '', 5, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:52:22');
...
INSERT INTO `gen_table_column` VALUES (205, 25, 'med_his_id', '既往用药号', 'int', 'Long', 'medHisId', '1', '1', '0', '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:52:57');
INSERT INTO `gen_table_column` VALUES (206, 25, 'patient_id', '病人号', 'varchar(20)', 'String', 'patientId', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:52:57');
INSERT INTO `gen_table_column` VALUES (207, 25, 'medication_name', '药物名称', 'varchar(100)', 'String', 'medicationName', '0', '0', '0', '1', '1', '1', '0', 'LIKE', 'input', '', 3, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:52:57');
INSERT INTO `gen_table_column` VALUES (208, 25, 'duration_days', '药物使用天数', 'int', 'Long', 'durationDays', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'input', '', 4, 'admin', '2025-06-27 14:25:10', '', '2025-06-27 15:52:57');
...
CREATE TABLE `history`  (
  ...
  INDEX `patient_id`(`patient_id` ASC) USING BTREE,
  CONSTRAINT `history_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `imaging`  (
  ...
  INDEX `patient_id`(`patient_id` ASC) USING BTREE,
  CONSTRAINT `imaging_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `insurance_info`  (
  ...
  INDEX `patient_id`(`patient_id` ASC) USING BTREE,
  CONSTRAINT `insurance_info_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `lab_tests`  (
  ...
  INDEX `patient_id`(`patient_id` ASC) USING BTREE,
  CONSTRAINT `lab_tests_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `lung_tests`  (
  ...
  INDEX `patient_id`(`patient_id` ASC) USING BTREE,
  CONSTRAINT `lung_tests_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `medical_orgs`  (
  ...
  INDEX `patient_id`(`patient_id` ASC) USING BTREE,
  CONSTRAINT `medical_orgs_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `medications`  (
  ...
  INDEX `patient_id`(`patient_id` ASC) USING BTREE,
  CONSTRAINT `medications_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `medications_history`  (
  ...
  INDEX `patient_id`(`patient_id` ASC) USING BTREE,
  CONSTRAINT `medications_history_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `patients` VALUES ('002', '2025-06-27 00:00:00', '李四', '女', '2025-06-06', 1, '福州', 1, 1, 1, '无');
...
CREATE TABLE `providers`  (
  ...
  INDEX `patient_id`(`patient_id` ASC) USING BTREE,
  CONSTRAINT `providers_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `symptoms`  (
  ...
  INDEX `patient_id`(`patient_id` ASC) USING BTREE,
  CONSTRAINT `symptoms_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2344 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '菜单权限表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (2254, '家族史', 2061, 1, 'family_history', 'ClinicalSys/family_history/index', NULL, '', 1, 0, 'C', '0', '0', 'ClinicalSys:family_history:list', '#', 'admin', '2025-06-27 16:16:15', '', NULL, '家族史菜单');
INSERT INTO `sys_menu` VALUES (2255, '家族史查询', 2254, 1, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:family_history:query', '#', 'admin', '2025-06-27 16:16:15', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2256, '家族史新增', 2254, 2, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:family_history:add', '#', 'admin', '2025-06-27 16:16:15', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2257, '家族史修改', 2254, 3, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:family_history:edit', '#', 'admin', '2025-06-27 16:16:15', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2258, '家族史删除', 2254, 4, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:family_history:remove', '#', 'admin', '2025-06-27 16:16:15', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2259, '家族史导出', 2254, 5, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:family_history:export', '#', 'admin', '2025-06-27 16:16:15', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2260, '既往史', 2061, 1, 'history', 'ClinicalSys/history/index', NULL, '', 1, 0, 'C', '0', '0', 'ClinicalSys:history:list', '#', 'admin', '2025-06-27 16:16:19', '', NULL, '既往史菜单');
INSERT INTO `sys_menu` VALUES (2261, '既往史查询', 2260, 1, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:history:query', '#', 'admin', '2025-06-27 16:16:19', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2262, '既往史新增', 2260, 2, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:history:add', '#', 'admin', '2025-06-27 16:16:19', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2263, '既往史修改', 2260, 3, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:history:edit', '#', 'admin', '2025-06-27 16:16:19', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2264, '既往史删除', 2260, 4, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:history:remove', '#', 'admin', '2025-06-27 16:16:19', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2265, '既往史导出', 2260, 5, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:history:export', '#', 'admin', '2025-06-27 16:16:19', '', NULL, '');
...
INSERT INTO `sys_menu` VALUES (2278, '实验室检查', 2061, 1, 'lab_tests', 'ClinicalSys/lab_tests/index', NULL, '', 1, 0, 'C', '0', '0', 'ClinicalSys:lab_tests:list', '#', 'admin', '2025-06-27 16:16:30', '', NULL, '实验室检查菜单');
INSERT INTO `sys_menu` VALUES (2279, '实验室检查查询', 2278, 1, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:lab_tests:query', '#', 'admin', '2025-06-27 16:16:30', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2280, '实验室检查新增', 2278, 2, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:lab_tests:add', '#', 'admin', '2025-06-27 16:16:30', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2281, '实验室检查修改', 2278, 3, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:lab_tests:edit', '#', 'admin', '2025-06-27 16:16:30', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2282, '实验室检查删除', 2278, 4, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:lab_tests:remove', '#', 'admin', '2025-06-27 16:16:30', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2283, '实验室检查导出', 2278, 5, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:lab_tests:export', '#', 'admin', '2025-06-27 16:16:30', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2284, '肺功能检查', 2061, 1, 'lung_tests', 'ClinicalSys/lung_tests/index', NULL, '', 1, 0, 'C', '0', '0', 'ClinicalSys:lung_tests:list', '#', 'admin', '2025-06-27 16:16:34', '', NULL, '肺功能检查菜单');
INSERT INTO `sys_menu` VALUES (2285, '肺功能检查查询', 2284, 1, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:lung_tests:query', '#', 'admin', '2025-06-27 16:16:34', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2286, '肺功能检查新增', 2284, 2, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:lung_tests:add', '#', 'admin', '2025-06-27 16:16:34', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2287, '肺功能检查修改', 2284, 3, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:lung_tests:edit', '#', 'admin', '2025-06-27 16:16:34', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2288, '肺功能检查删除', 2284, 4, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:lung_tests:remove', '#', 'admin', '2025-06-27 16:16:34', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2289, '肺功能检查导出', 2284, 5, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:lung_tests:export', '#', 'admin', '2025-06-27 16:16:34', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2290, '既往用药史', 2061, 1, 'medications_history', 'ClinicalSys/medications_history/index', NULL, '', 1, 0, 'C', '0', '0', 'ClinicalSys:medications_history:list', '#', 'admin', '2025-06-27 16:16:37', '', NULL, '既往用药史菜单');
INSERT INTO `sys_menu` VALUES (2291, '既往用药史查询', 2290, 1, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:medications_history:query', '#', 'admin', '2025-06-27 16:16:37', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2292, '既往用药史新增', 2290, 2, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:medications_history:add', '#', 'admin', '2025-06-27 16:16:37', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2293, '既往用药史修改', 2290, 3, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:medications_history:edit', '#', 'admin', '2025-06-27 16:16:37', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2294, '既往用药史删除', 2290, 4, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:medications_history:remove', '#', 'admin', '2025-06-27 16:16:37', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2295, '既往用药史导出', 2290, 5, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'ClinicalSys:medications_history:export', '#', 'admin', '2025-06-27 16:16:37', '', NULL, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 194 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
